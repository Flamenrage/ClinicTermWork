...
<body>
     <form id="form1" runat="server">
        <div style="height: 241px">
            ...
            <br />
            ФИО&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="textBoxFIO" runat="server" Height="16px" Width="276px" style="margin-bottom: 0px">Alina</asp:TextBox>
            &nbsp;<br />
            <br />
            Почта&nbsp;&nbsp;&nbsp; <asp:TextBox ID="textBoxEmail" runat="server" Height="16px" Width="280px">alinok2000@gmail.com</asp:TextBox>
            <br />
            <br />
            Пароль&nbsp;
